...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2014 at 07:19 AM
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `user_open_hour` varchar(255) NOT NULL DEFAULT '{"Monday":[8,20],"Monday":[8,20],"Monday":[8,20],"Tueday":[8,20],"Wednesday":[8,20],"Thursday":[8,20],"Friday":[8,20],"Saturday":[],"Sunday":[]}',
