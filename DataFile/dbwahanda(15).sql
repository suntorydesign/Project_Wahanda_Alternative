...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2014 at 07:32 AM
...
INSERT INTO `appointment` (`appointment_id`, `appointment_title`, `appointment_date`, `appointment_time_start`, `appointment_time_end`, `appointment_price`, `appointment_status`, `appointment_note`, `appointment_client_name`, `appointment_client_email`, `appointment_client_phone`, `appointment_client_sex`, `appointment_client_birth`, `appointment_client_note`, `appointment_created`, `appointment_updated`, `appointment_user_id`, `appointment_user_service_id`) VALUES
(1, 'Non title', '2014-10-10', '08:00:00', '08:30:00', 0, 0, '', 'Khach hang A', '', '', 0, '0000-00-00', '', '0000-00-00 00:00:00', '0000-00-00', 1, 1),
(3, '', '2014-10-14', '09:00:00', '09:30:00', 400000, 0, '', '', '', '', 0, '0000-00-00', '', '0000-00-00 00:00:00', '0000-00-00', 1, 2),
(5, '', '2014-10-10', '16:00:00', '16:45:00', 350000, 0, '', '', '', '', 0, '0000-00-00', '', '2014-10-28 05:59:53', '0000-00-00', 1, 4),
(7, 'Nhật', '2014-10-02', '09:45:00', '10:30:00', 350000, 0, '', 'Nhật', 'trongloi@gmail.com', '902930293', 0, '0000-00-00', '', '2014-10-28 12:35:42', '0000-00-00', 1, 4),
(8, 'Nhat', '2014-10-08', '10:00:00', '11:00:00', 520000, 0, '', 'Nhat', 'nhat@gmail.com', '0090909', 0, '0000-00-00', 'Anh nhat binh thanh', '2014-10-29 03:40:10', '0000-00-00', 1, 10);
...
INSERT INTO `booking_detail` (`booking_detail_id`, `booking_detail_price`, `booking_detail_quantity`, `booking_detail_date`, `booking_detail_time_start`, `booking_detail_time_end`, `booking_detail_user_id`, `booking_detail_user_service_id`, `booking_detail_booking_id`, `booking_detail_status`, `booking_detail_note`) VALUES
(1, 400000, 1, '2014-10-15', '08:30:00', '09:00:00', 1, 1, '1', 0, ''),
(21, 380000, 1, '2014-10-24', '19:00:00', '19:00:00', 1, 23, 'BKc8398c85b0', 0, ''),
(22, 520000, 1, '2014-10-24', '17:20:00', '17:20:00', 1, 3, 'BK9d98f1c26d', 0, ''),
(24, 520000, 1, '2014-10-27', '14:40:00', '14:40:00', 1, 3, 'BKcf9a7c4234', 0, ''),
(25, 520000, 1, '2014-10-30', '12:00:00', '12:00:00', 1, 3, 'BKec1babed1f', 0, '');
...
CREATE TABLE IF NOT EXISTS `e_voucher` (
  ...
  `e_voucher_quantity` int(11) NOT NULL DEFAULT '1',
  ...
  `e_voucher_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `e_voucher` (`e_voucher_id`, `e_voucher_due_date`, `e_voucher_price`, `e_voucher_quantity`, `e_voucher_user_service_id`, `e_voucher_booking_id`, `e_voucher_user_id`, `e_voucher_status`, `e_voucher_created`) VALUES
('E-032f2fe33c8862e5', '2015-03-22', 350000, 3, 4, 'BK8131c14311', 1, 0, '2014-10-28 15:45:04'),
('E-9405b6ef6803e29e', '2015-03-22', 350000, 1, 4, 'BK9d98f1c26d', 1, 0, '2014-10-28 15:45:04'),
('E-b236f3ed8dcf0a4a', '2015-03-28', 350000, 1, 4, 'BKeab08d11ab', 1, 0, '2014-10-28 15:45:04');
