...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2014 at 02:54 PM
...
CREATE TABLE IF NOT EXISTS `appointment` (
  ...
  `appointment_status` int(11) NOT NULL DEFAULT '0' COMMENT '0: chua xong, chua thanh toan\n1: da xong, da thanh toan',
  `appointment_note` text NOT NULL,
  `appointment_is_confirm` int(11) NOT NULL DEFAULT '0',
  ...
  `appointment_del_flag` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `appointment` (`appointment_id`, `appointment_title`, `appointment_date`, `appointment_time_start`, `appointment_time_end`, `appointment_price`, `appointment_status`, `appointment_note`, `appointment_is_confirm`, `appointment_client_name`, `appointment_client_email`, `appointment_client_phone`, `appointment_client_sex`, `appointment_client_birth`, `appointment_client_note`, `appointment_created`, `appointment_updated`, `appointment_user_id`, `appointment_user_service_id`, `appointment_del_flag`) VALUES
(25, 'Trong loi', '2014-10-31', '08:00:00', '08:00:00', 350000, 1, '', 1, 'Trong loi', '', '909909090', 0, '0000-00-00', '', '2014-11-12 09:25:29', '0000-00-00', 1, 4, 1),
(26, '', '2014-10-31', '08:00:00', '08:45:00', 350000, 0, '', 0, '', '', '', 0, '0000-00-00', '', '2014-11-12 09:28:08', '0000-00-00', 1, 4, 1);
...
CREATE TABLE IF NOT EXISTS `booking_detail` (
  ...
  `booking_detail_status` int(11) NOT NULL DEFAULT '0',
  `booking_detail_note` text NOT NULL,
  `booking_detail_is_confirm` int(11) NOT NULL DEFAULT '0',
  `booking_detail_del_flag` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `booking_detail` (`booking_detail_id`, `booking_detail_price`, `booking_detail_quantity`, `booking_detail_date`, `booking_detail_time_start`, `booking_detail_time_end`, `booking_detail_user_id`, `booking_detail_user_service_id`, `booking_detail_booking_id`, `booking_detail_status`, `booking_detail_note`, `booking_detail_is_confirm`, `booking_detail_del_flag`) VALUES
(1, 400000, 1, '2014-10-15', '08:30:00', '09:00:00', 1, 1, '1', 0, '', 0, 0),
(21, 380000, 1, '2014-10-24', '19:00:00', '19:00:00', 1, 23, 'BKc8398c85b0', 0, '', 0, 0),
(22, 520000, 1, '2014-10-24', '17:20:00', '17:20:00', 1, 3, 'BK9d98f1c26d', 0, '', 0, 0),
(24, 520000, 1, '2014-10-27', '14:40:00', '14:40:00', 1, 3, 'BKcf9a7c4234', 0, '', 0, 0),
(25, 520000, 1, '2014-10-30', '12:00:00', '12:00:00', 1, 3, 'BKec1babed1f', 1, '', 1, 0),
(31, 520000, 1, '2014-11-07', '13:20:00', '13:20:00', 1, 3, 'BK16109cd12f', 0, '', 0, 0),
(32, 520000, 1, '2014-11-06', '12:00:00', '12:00:00', 1, 3, 'BKfc80b3ff4c', 0, '', 0, 0),
(33, 520000, 1, '2014-11-06', '10:40:00', '10:40:00', 1, 3, 'BKc5f57b7c76', 0, '', 0, 0),
(34, 520000, 1, '2014-11-13', '08:00:00', '08:00:00', 1, 3, 'BK32400d2c37', 0, '', 0, 0),
(35, 520000, 1, '2014-11-06', '10:40:00', '10:40:00', 1, 3, 'BKaf2b212507', 0, '', 0, 0);
...
(2, 'G-18eceebc01', '2015-04-26', 'chào mày\nNhớ t không\nSN vui vẻ nhé\nmau có gấu đi cha', '200000', 'Thằng cớ hó', '10520649@gm.uit.edu.vn', 1, '2014-11-26', 0, '2014-11-14 13:41:06', 2),
(4, 'G-495c3a689b', '2015-04-26', 'chào mày\nNhớ t không\nSN vui vẻ nhé\nmau có gấu đi cha', '200000', 'Thằng cớ hó', '10520649@gm.uit.edu.vn', 1, '2014-11-26', 0, '2014-11-14 13:41:04', 2),
(5, 'G-b99ea7adc4', '2015-04-26', 'chào mày\nNhớ t không\nSN vui vẻ nhé\nmau có gấu đi cha', '200000', 'Thằng cớ hó', '10520649@gm.uit.edu.vn', 1, '2014-11-26', 0, '2014-11-14 13:41:02', 2),
(6, 'G-26c82766a6', '2015-04-26', 'chào mày\nNhớ t không\nSN vui vẻ nhé\nmau có gấu đi cha', '200000', 'Thằng cớ hó', '10520649@gm.uit.edu.vn', 1, '2014-11-26', 0, '2014-11-14 13:40:59', 2),
(7, 'G-5d9d7d168a', '2015-04-26', 'chào mày\nNhớ t không\nSN vui vẻ nhé\nmau có gấu đi cha', '200000', 'Thằng cớ hó', '10520649@gm.uit.edu.vn', 1, '2014-11-26', 0, '2014-11-14 13:40:56', 2),
(8, 'G-0e507800b0', '2015-04-26', 'chào mày\nNhớ t không\nSN vui vẻ nhé\nmau có gấu đi cha', '200000', 'Thằng cớ hó', '10520649@gm.uit.edu.vn', 1, '2014-11-26', 0, '2014-11-14 13:40:39', 2),
(9, 'G-bdb362ab5f', '2015-04-25', 'Chúc em sinh nhật vui vẻ\nLuôn hạnh phúc em nhé', '200000', 'Nguyễn Tèo Em', 'vietnt134@gmail.com', 1, '2014-11-25', 0, '2014-11-14 14:54:54', 2),
(10, 'G-e850b06c00', '2015-04-26', 'Chúc em sinh nhật vui vẻ\nChị Thúy!', '500000', 'Mai Phương Thúy', 'vietnt134@gmail.com', 1, '2014-11-26', 0, '2014-11-14 14:57:46', 2),
(11, 'G-38b17b2ada', '2015-04-26', 'Anh chúc em sinh nhật vui vẻ nhá\nThần tượng của anh\nSiêu Mẩu Bình Minh!', '500000', 'Bình Minh', 'vietnt134@gmail.com', 2, '2014-11-26', 0, '2014-11-14 15:01:44', 2),
(12, 'G-83c0300a02', '2015-04-15', 'Chúc mày sinh nhật vui vẻ nhá\nBạn thần của mày! :D', '200000', 'Nguyễn Tèo', 'vietnt134@gmail.com', 2, '2014-11-15', 0, '2014-11-14 15:07:49', 2);
...
(13, 'Uốn tóc kiểu Hàn Quốc', 60, '120000', '98000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/73225-1920x1200.jpg', 'Chào các bạn đã đến với Spa chúng tôi, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 1, 5, 1),
...
(16, 'Nhuộm da USA', 60, '580000', '480000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/73225-1920x1200.jpg', 'Chào các bạn đã đến với Spa chúng tôi, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 6, 8, 1),
(17, 'Nhuộm tóc Hàn', 60, '152000', '120000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/2/262144-1920x1080.jpg', 'Chào các bạn đã đến với Spa chúng tôi, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 1, 3, 1),
(18, 'Tắm trắng', 60, '1800000', '1710000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/2/262144-1920x1080.jpg', 'Chào các bạn đã đến với Spa chúng tôi, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 1, 2, 1),
...
(21, 'Cắt tóc chuyên nghiệp', 60, '600000', '500000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/Short-Mohawk-Hairstyles-for-Boys.jpg', 'Chào các bạn đã đến với Spa chúng tôi, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 1, 6, 1, 0),
(22, 'Chăm sóc móng', 60, '600000', '580000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/unha2.jpg', 'Chào các bạn đã đến với Spa chúng tôi, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 1, 6, 6, 0),
(23, 'Cắt tóc Nhật Bản', 60, '600000', '380000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/91706-1366x768.jpg', 'Chào các bạn đã đến với Spa chúng tôi, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 6, 1, 0),
(24, 'Làm đầu', 60, '40000', '', 1, '', '', 0, 1, 2, 2, 1),
(25, 'Làm đầu', 60, '40000', '', 1, '', '', 0, 1, 2, 2, 1),
(26, 'Làm đầu', 60, '40000', '', 1, '', '', 0, 1, 2, 2, 1),
(27, 'Làm đầu', 60, '40000', '', 1, '', '', 0, 0, 2, 2, 1),
(28, 'Cắt tóc chuyên nghiệp', 10, '400000', '', 1, '', '', 0, 0, 9, 1, 1),
(29, 'Cắt tóc chuyên nghiệp', 10, '400000', '', 1, '', '', 0, 0, 9, 1, 1);
