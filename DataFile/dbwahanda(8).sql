...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2014 at 04:37 AM
...
(1, 'LeTrongLoi', 'trongloikt192@gmail.com', 'bd18fa92a97df32d0da484fe76ad2dc2', '123456789', '70000', 'trongloikt192', 0, 0, 0, '1992-01-01', 0, '2014-09-01', '88399349280acb8805887b3a269a02ea', 1),
(2, 'Nguyễn Trung Việt', 'vietnt134@gmail.com', 'a3ed0c6e51714fedb944c820b63b3c7a', '0903676222', '70000', 'viet_nt', 0, 0, 0, '1992-01-01', 0, '2014-09-12', '2d4e4f0b2a29ce2484d87c69ec77c09b', 1);
...
(3, 'Chăm sóc móng chuyên nghiệp', 2),
(4, 'Làm mặt Brazil', 3),
(5, 'Thể dục thẩm mỹ', 4);
...
(6, 'Chăm sóc móng', '', 3),
(7, 'Làm mặt, massage, trang điểm', '', 4),
(8, 'Fitness, thể dục thẩm mỹ', '', 6);
...
CREATE TABLE IF NOT EXISTS `user_review` (
  ...
  `user_review_content` text NOT NULL,
...
INSERT INTO `user_review` (`user_id`, `client_id`, `user_review_content`, `user_review_active`, `user_review_clean`, `user_review_quality`, `user_review_staff`, `user_review_valuable`, `user_review_time`, `user_review_date`) VALUES
(1, 2, 'Dịch vụ rất bình thường.', 0, 0, 0, 0, 0, '23:05:27', '0000-00-00'),
(2, 2, 'Dịch vụ ở đây cực kỳ hay luôn, rất nhanh và sạch sẽ, mình cho 4 sao luôn nhá.', 0, 0, 0, 0, 0, '23:20:07', '2014-09-26'),
(3, 2, 'Nhân viên cực kỳ dễ thường luôn, đặc biệt là anh Thành hugo anh ấy dễ thương value luôn đó nhá, các bạn nên dùng dịch vụ này đi hay phải biết luốn ấy. Ngoài ra các dịch vụ ở đây còn rất là chất lượng nên mình chấm cho 5 sao luôn.', 0, 0, 0, 0, 0, '23:10:27', '2014-09-26'),
(4, 2, 'Dịch vụ hơi bị ổn... các bạn ạ, yeah', 0, 0, 0, 0, 0, '23:08:27', '2014-09-26');
...
CREATE TABLE IF NOT EXISTS `user_service` (
  ...
  `user_service_highlight` int(11) NOT NULL DEFAULT '0',
...
(2, 'Massage toản thân trắng da mịn màng', 80, '450000', '400000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/73225-1920x1200.jpg', 'Đến với spa của chị Ngọc Trinh chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 1, 2, 5, 0),
(3, 'Massage mặt (bonus làm móng)', 80, '600000', '520000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/73225-1920x1200.jpg', 'Đến với spa của chị Ngọc Trinh chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 2, 4, 0),
(4, 'Cắt tóc cô dâu', 45, '400000', '350000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/1/73225-1920x1200.jpg', 'Đến với spa của chị Ngọc Trinh chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 1, 0, 1, 1, 0),
(5, 'Làm móng Âu Mỹ', 40, '400000', '320000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/2/262144-1920x1080.jpg', 'Đến với spa của Hoàn Vũ chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về móng...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 1, 3, 6, 0),
(6, 'Làm mặt (Massage)', 60, '400000', '380000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/2/262144-1920x1080.jpg', 'Đến với spa Robot chúng ta sẽ được phục vụ tận tình, đội ngũ nhân viên của Spa nhanh nhẹn như Robot, Spa bao gồm các dịch vụ về làm mặt và Massage...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 1, 4, 7, 0),
(7, 'Thể dục thẩm mỹ kết hợp yoga', 60, '800000', '690000', 1, '//localhost:81/project_wahanda_alternative/public/assets/plugins/image-manager/upload/2/262144-1920x1080.jpg', 'Đến với Hallo chúng ta sẽ được phục vụ tận tình, đội ngũ nhân viên của Hallo nhanh nhẹn tận tâm, Salon bao gồm các dịch vụ về thể dục thẩm mỹ, chăm sóc body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Salon, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 5, 8, 0);
