...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2014 at 08:38 AM
...
INSERT INTO `client` (`client_id`, `client_name`, `client_email`, `client_pass`, `client_phone`, `client_postcode`, `client_username`, `client_sex`, `client_creditpoint`, `client_giftpoint`, `client_birth`, `client_is_sendmail`, `client_verify`, `client_is_active`) VALUES
(1, 'LeTrongLoi', 'trongloikt192@gmail.com', 'bd18fa92a97df32d0da484fe76ad2dc2', '123456789', '70000', 'trongloikt192', 0, 0, 0, '1992-01-01', 0, '88399349280acb8805887b3a269a02ea', 1),
(2, 'Nguyễn Trung Việt', 'vietnt134@gmail.com', 'a3ed0c6e51714fedb944c820b63b3c7a', '0903676222', '70000', 'viet_nt', 0, 0, 0, '1992-01-01', 0, '2d4e4f0b2a29ce2484d87c69ec77c09b', 1);
...
(1, 'Cắt tóc Hàn Quốc dành cho nữ', 30, '400000', '350000', 1, '', 'Đến với spa của chị Ngọc Trinh chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 1, 1, 0),
(2, 'Massage toản thân trắng da mịn màng', 80, '450000', '400000', 1, '', 'Đến với spa của chị Ngọc Trinh chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 2, 5, 0),
(3, 'Massage mặt (bonus làm móng)', 80, '600000', '520000', 1, '', 'Đến với spa của chị Ngọc Trinh chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 0, 0, 2, 4, 0),
(4, 'Cắt tóc cô dâu', 45, '400000', '350000', 1, '', 'Đến với spa của chị Ngọc Trinh chúng ta sẽ được phục vụ tận tình, Spa bao gồm các dịch vụ về tóc, body...đồng thời khi đã là thành viên, quý khách sẽ được hưởng các ưu đãi có 1 không 2 của Spa, nhanh chân lên khi ưu đãi là có hạn', 1, 0, 1, 1, 0);
