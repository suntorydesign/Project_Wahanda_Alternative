<div class="container">
	...
	<div class="row">
		<div class="col-md-12 thumbnail" style="border-radius: 0px">
			<h4 class="text-center" style="color: #FFCC00"><i class="fa fa-shopping-cart"></i><b> CHI TIẾT GIFT VOUCHER</b></h4>
			<div class="table-responsive">
				<table id="table_giftpayment_detail" class="table table-responsive">
					<tr>
						<th  style="border: none">NGƯỜI GỬI</th>
						<th  style="border: none">ĐẾN EMAIL</th>
						<th  style="border: none">LOẠI</th>
						<th  style="border: none">NGÀY</th>
						<th  style="border: none">THÔNG ĐIỆP</th>
			...
			<div class="row">
				...
				<div id="online_payment" class="col-md-12">
					<div style="background-color: #f7f7f7; padding: 24px 12px 24px 12px;">
						<div class="form-horizontal payment_field">
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<input value="6011740673598830" value="" onkeypress="inputNumbers(event)" class="form-control" type="text" id="client_card_number" name="client_card_number">
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<input value="" onkeypress="inputNumbers(event)" maxlength="4" class="form-control" type="text" id="client_security_code" name="client_security_code">
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input value="" class="form-control" type="text" id="client_card_holder_first" name="client_card_holder_first" placeholder="HỌ">
										</div>
										<div class="col-sm-6">
											<input value="" class="form-control" type="text" id="client_card_holder_last" name="client_card_holder_last" placeholder="TÊN">
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input value="" onkeypress="inputNumbers(event)" maxlength="2" class="form-control" type="text" id="month_expire" name="month_expire" placeholder="MM">
										</div>
										<div class="col-sm-6">
											<input value="" onkeypress="inputNumbers(event)" maxlength="4" class="form-control" type="text" id="year_expire" name="year_expire" placeholder="YYYY">
										</div>
									</div>
								</div>
							</div>
