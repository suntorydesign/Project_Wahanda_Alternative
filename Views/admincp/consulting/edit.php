<div id="home-holder" class="content-holder pending">
	...
	<div class="main-content" id="main_detail">
		<h3 class="add-place">Sửa/ Xóa một luật</h3>
		<hr />
		<div class="row">
			<div class="col-md-6">
				<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<button onclick="editRule()" id="btn_edit_rule" type="button" class="button action action-default button-primary save-action">
					<div class="button-inner">
				...
				<button onclick="deleteRule()" id="btn_delete_rule" type="button" class="button action action-default button-secondary save-action">
					<div class="button-inner">
				...
				<small id="error_edit_consult" style="color: red; display: none;">Nhập đầy đủ các trường có (*)</small>
			</div>
		</div>
	</div>
</div>
<script>
	...
	var IS_ADD = 0;
	var IS_EDIT = 1;
	var RULE_ID =  "<?php echo $this -> rule_id; ?>";
